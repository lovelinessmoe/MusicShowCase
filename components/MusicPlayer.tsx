  ...
  return (
    <div className={`w-full mx-auto ${hasLyrics ? 'max-w-7xl' : 'max-w-2xl'}`}>
      <div className={`flex ${hasLyrics ? 'flex-col lg:flex-row' : 'justify-center'} gap-6 items-start`}>
        ...
        {/* 歌词显示区域 - 在右侧，高度自适应左边 */}
        {hasLyrics && (
          <div className="w-full lg:flex-1 lg:max-h-[700px] p-6 bg-gradient-to-br from-white/5 via-blue-500/5 to-purple-500/5 backdrop-blur-lg rounded-2xl shadow-2xl border border-white/10 relative overflow-hidden">
            {/* 背景装饰 */}
